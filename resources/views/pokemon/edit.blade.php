...
<div class="pokemon-form">
    <div class="container">
        <div class="form-container">
            ...
            <form action="{{ url('pokemon/' . $pokemon->id) }}" method="post" class="form" id="form" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="form-input-container">
                    <label for="id">ID Pokemon</label>
                    <input type="text" name="id" id="id" placeholder="ID pokemon" disabled class="form-input" value="{{ $pokemon->id }}">
                </div>
                <div class="form-input-container">
                    <label for="nombre">Nombre</label>
                    <input type="text" name="nombre" id="nombre" placeholder="Nombre pokemon" required class="form-input" minlenght="2" maxlenght="50" value="{{ old('nombre', $pokemon->nombre) }}">
                </div>
                <div class="form-input-container">
                    <label for="altura">Altura</label>
                    <input type="number" name="altura" id="altura" placeholder="Altura pokemon" class="form-input" min="0.00" max="9999.99" step="0.01" value="{{ old('altura', $pokemon->altura) }}">
                </div>
                <div class="form-input-container">
                    <label for="peso">Peso</label>
                    <input type="number" name="peso" id="peso" placeholder="Peso pokemon" class="form-input" min="0.00" max="9999.99" step="0.01" value="{{ old('peso', $pokemon->peso) }}">
                </div>
                <div class="form-input-container">
                ...
                <input type="submit" value="Editar Pokemon" id="form-button" class="form-button">
            </form>
